...
7. [ADR-007: مرجعیت واحد چنج‌لاگ در docs/CHANGELOG.md](#adr-007)
...
<a id="adr-007"></a>
### 🔷 ADR-007: مرجعیت واحد چنج‌لاگ در docs/CHANGELOG.md

* **تاریخ:** ۱۴۰۵/۰۵/۲۷  
* **وضعیت:** `تأییدشده و اجراشده (Approved & Implemented)`  
* **مکان کد:** [`docs/CHANGELOG.md`](file:///home/unreal/projects/HikStatus/docs/CHANGELOG.md)

#### 📝 سیاق و مسئله (Context)
وجود دو فایل چنج‌لاگ موازی (`docs/CHANGELOG.md` و `.agents/CHANGELOG.md`) باعث دوباره‌کاری در نگهداری تاریخچه و احتمال بروز ناهماهنگی میان مستندات عمومی و اسناد ایجنت‌ها می‌شد.

#### 🎯 تصمیم (Decision)
تمامی تغییرات و شناسنامه نسخه‌ها در یک فایل واحد در [`docs/CHANGELOG.md`](file:///home/unreal/projects/HikStatus/docs/CHANGELOG.md) بر اساس استاندارد Keep a Changelog و تاریخ‌های شمسی تجمیع گردید و فایل موازی در `.agents/` حذف شد. همچنین گردش کار ایجنت‌ها (`.agents/workflows/changelog.yaml`) به این فایل هدایت شد.

#### ⚡ پیامدها (Consequences)
* ✅ وجود تنها یک منبع واحد برای پیگیری تاریخچه پروژه.
* ✅ جلوگیری از دوباره‌کاری و سردرگمی ایجنت‌ها و کاربران.
