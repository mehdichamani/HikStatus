...
- [x] **امکان ویرایش کاربران و کارخانه‌ها (گروه‌ها) در پنل تنظیمات**
- **توضیح**: قابلیت ویرایش مشخصات کاربران (شامل تغییر نقش، تغییر کارخانه‌های مجاز برای ناظرین و تغییر وضعیت فعال/غیرفعال بودن حساب) و همچنین ویرایش مشخصات کارخانه‌ها (شامل نام و توضیحات) پیاده‌سازی و دکمه‌های مربوطه به رابط کاربری اضافه شدند.
...
- [x] **رفع مشکل عدم نمایش فیلترهای تب لاگ در حالت موبایل**
- **توضیح**: کلاس‌های CSS مربوط به نمایش پنل فیلترها در موبایل اصلاح شدند تا از تداخل با استایل‌های بخش گزارشات جلوگیری شود. فیلترها و دکمه‌های دسته‌بندی لاگ اکنون در صفحات کوچک به صورت خودکار زیر هم قرار گرفته و دکمه‌ها به شکل ریسپانسیو و افقی (wrapping) چیده می‌شوند.
